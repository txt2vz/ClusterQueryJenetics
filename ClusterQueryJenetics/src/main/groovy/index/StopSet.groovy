...
class StopSet {
	...
	static final String[] smallStopSet = ["a", "an", "and", "are", "as", "at", "be", "but", "by", "for", "if", "in", "into", "is", "it", "no", "not", "of", "on", "or", "such", "that", "the", "their", "then", "there", "these", "they", "this", "to", "was", "will", "with", "1", "2", "3", "4", "5", "6", "7", "8", "9", "0", //for webkb
